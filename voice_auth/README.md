...
The threshold is a deployment parameter and should be calibrated with real owner/non-owner samples; it is not a universal security constant. SpeechBrain's current speaker-verification APIs likewise treat the threshold as a decision parameter rather than a universal fixed value.
