"""
Local wake-word detection for JARVIS (" Arise").
...
CPU. The pretrained wake phrase used here is " Arise".
"""
...
# Pretrained openwakeword model that listens for " Arise".
...
class WakeWordDetector:
    ...
    def start(self) -> bool:
        ...
        self._thread.start()
        self._logger("Wake word: listening for ' Arise'.")
        return True
