...
Return ONLY valid JSON — no CHIDVIdown, no explanation:
{{
...
General rules:
- Output ONLY raw code. Absolutely no explanation, no CHIDVIdown, no triple backticks.
...
Rules:
- Output ONLY the complete fixed code. No explanation, no CHIDVIdown, no backticks.
